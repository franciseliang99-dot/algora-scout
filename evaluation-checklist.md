...
| R17 | Issue body contains "needs to be handled internally" / "this will be handled by the core team" / "do not create a PR" | cal.com 在部分 [CAL-XXXX] 议题顶部用这句话锁内部,跟 archestra "Reserved for SE interview" / activepieces "finalized for this bounty" 同质但措辞不同,grep 必须独立。例:cal.com #18992 (no-show zapier $50)。 |
